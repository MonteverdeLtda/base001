...
Class staticMapLite
{
    ...
    protected $tileSrcUrl = array('mapnik' => 'https://c.tile.openstreetmap.org/{Z}/{X}/{Y}.png',
        'german' => 'https://a.tile.openstreetmap.de/{Z}/{X}/{Y}.png',
        'wikimedia' => 'https://maps.wikimedia.org/osm-intl/{Z}/{X}/{Y}.png',
        'opnvkarte' => '	http://tile.memomaps.de/tilegen/{Z}/{X}/{Y}.png',
        'osmarenderer' => 'http://otile1.mqcdn.com/tiles/1.0.0/osm/{Z}/{X}/{Y}.png',
        'cycle' => 'http://a.tile.opencyclemap.org/cycle/{Z}/{X}/{Y}.png',
    );

    protected $tileDefaultSrc = 'mapnik';
    protected $markerBaseDir = '/home/admin/web/micuenta.monteverdeltda.com/public_html/public/assets/images/markers';
	// Images
    protected $osmLogo = '/home/admin/web/micuenta.monteverdeltda.com/public_html/public/assets/images/images/osm_logo.png';
